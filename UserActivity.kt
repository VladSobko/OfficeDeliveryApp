...
import com.example.vlad.deliveryinstantapp.adapter.UserAdapter
...
import kotlinx.android.synthetic.main.list_item_delivery.*
...
class UserActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_cart.setOnClickListener {
            ...
            val intent = Intent(this@UserActivity, CartActivity::class.java)
            startActivity(intent)
        ...
        button_cart.background = drawable
            ...
            .addSnapshotListener(EventListener { documentSnapshots, e ->
                ...
                if (documentSnapshots != null) {
                    for (doc in documentSnapshots) {
                        ...
                        note.id = doc.id
                        notesList.add(note)
                        runAnimation(rvNoteListu!!)

                    }
                }

                mAdapter = UserAdapter(notesList, applicationContext, firestoreDB!!)
                rvNoteListu.adapter = mAdapter
            })
    }
        ...
        firestoreDB!!.collection("notes")
            ...
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    rvNoteListu.layoutManager = mLayoutManager
                    rvNoteListu.itemAnimator = DefaultItemAnimator()
                    rvNoteListu.adapter = mAdapter
                } else {
